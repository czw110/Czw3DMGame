    ...
    public static boolean saveData(List<News> list){
        ...
        if (list!=null){
            for (News news:list){
                ...
                db.execSQL("create table if not exists news(id integer,typeid varchar(10),title varchar(50), shorttitle varchar(50),imgpath varchar(50),senddate varchar(50),feedback varchar(50),arcurl varchar(50))");
                Log.i("aaa","创建表");
...
//                        +id+",'"+typeid+"','"+title+"','"+shorttitle+"','"+imgpath+"','"+senddate+"','"+feedback+"','"+arcurl+"')");
                db.execSQL("insert into news(id,typeid,title,shorttitle,imgpath,senddate,feedback,arcurl) values("+id+",'"+typeid+"','"+title+"','"+shorttitle+"','"+imgpath+"','"+senddate+"','"+feedback+"','"+arcurl+"')");
                ++i;
